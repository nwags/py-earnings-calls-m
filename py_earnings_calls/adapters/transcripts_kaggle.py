...
_CANDIDATE_TEXT_COLUMNS = ["transcript", "content", "text", "body", "article_text", "transcript_text"]
_CANDIDATE_DATE_COLUMNS = ["date", "call_date", "published_at", "published_date", "call_datetime"]
_CANDIDATE_COMPANY_COLUMNS = ["company", "company_name", "companytitle", "title_company", "name"]
...
class KaggleMotleyFoolTranscriptAdapter(TranscriptBulkAdapter):
    ...
    def load_documents(self, dataset_path: str) -> list[TranscriptDocument]:
        ...
        for row in df.to_dict(orient="records"):
            ...
            if raw_date is not None:
                call_datetime = parse_call_datetime(raw_date)
